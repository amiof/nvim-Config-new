...
whichkey.add({
  ...
  { "<leader>d", group = "diagnostics", nowait = false, remap = false, icon = "  " },
  { "<leader>db", desc = "add [B]reakpoint for debug", nowait = false, remap = false },
  { "<leader>f", group = " find", nowait = false, remap = false, icon = "󰸱 " },
  { "<leader>rf", "", desc = "format code", nowait = false, remap = false, icon = "󰸱 " },
  { "<leader>fC", "<cmd>Telescope commands<CR>", desc = "search Commands", nowait = false, remap = false },
  { "<leader>fc", "<cmd>Telescope colorscheme<CR>", desc = "Change [C]olorscheme", nowait = false, remap = false },
  { "<leader>fk", "<cmd>Telescope keymaps<CR>", desc = "search [k]eymaps", nowait = false, remap = false },
  { "<leader>fm", "<cmd>Telescope man_pages<CR>", desc = "search [m]an_pages", nowait = false, remap = false },
  -- { "<leader>fn", "", desc = "find file", nowait = false, remap = false, icon = "󰸱 " },
  -- -- { "<leader>fg", "", desc = "find grep", nowait = false, remap = false, icon = "󰸱 " },
  -- { "<leader>fw", "", desc = "find word", nowait = false, remap = false, icon = "󰸱 " },
  { "<leader>g", group = "git", nowait = false, remap = false, icon = "󰊢 " },
  ...
  { "<leader>n", group = "[t]est whit neotest", nowait = false, remap = false, icon = "󰙨 " },
  ...
  { "<leader>r", group = "lsp refactor", nowait = false, remap = false, icon = " 󰑕 " },
